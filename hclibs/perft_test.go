...
func TestGenerateMoves(t *testing.T) {
	...
	tap.Is(IsValidMove(Move{from: A2, to: A3, mtype: QUIET, piece: PAWN}, &p), true, "Testing IsValidMove - finds correct move")
	tap.Is(IsValidMove(Move{from: A2, to: B3, mtype: CAPTURE, piece: PAWN}, &p), false, "Testing IsValidMove - finds incorrect move")
	//tap.Is("Aaa", "Aaa", "Is")
