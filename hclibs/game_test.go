...
func TestParseUserMove(t *testing.T) {
	...
	tap.Is(text, "Error (unparseable as user move): 4a4a", "Unparseable input")
	_, text = ParseUserMove("4a4az", &p)
	tap.Is(text, "Error (unparseable as user move): 4a4az", "Unparseable input")
	_, text = ParseUserMove("a4a4", &p)
	tap.Is(text, "Illegal move: a4a4", "not a valid move")
	_, text = ParseUserMove("a4a4q", &p)
	tap.Is(text, "Illegal move: a4a4q", "not a valid move")
	_, text = ParseUserMove("a1a2", &p)
	tap.Is(text, "Illegal move: a1a2", "not a valid move")
